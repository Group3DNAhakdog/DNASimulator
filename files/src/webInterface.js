...
var PhosphateGroupDescription = "<div class='DescriptionHeader'>Phosphate Group</div><br/>A functional group characterized by a phosphorus atom bonded to four oxygen atoms (three single bonds and one double bond). One of these oxygen atoms must be bonded to another atom; if not, the structure is a phosphate ion."
