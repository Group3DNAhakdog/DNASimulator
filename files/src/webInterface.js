...
var html_PosphateGroupId = document.getElementById("PosphateGroupId")
var html_HydrogenBondsId = document.getElementById("HydrogenBondsId")
var html_PosphodiesterBondsId = document.getElementById("PosphodiesterBondsId")


var NitrogenousBaseDescription = `
<div class="NitrogenousBaseHeader" style="color: #8bd973;" onclick="selectTab('Thymine')">Thymine</div><br/>
...
<br/><br/>
<div class="NitrogenousBaseHeader" style="color: #b572d4;" onclick="selectTab('Adenine')">Adenine</div><br/>
...
<br/><br/>
<div class="NitrogenousBaseHeader" style="color: #f26f68;" onclick="selectTab('Guanine')">Guanine</div><br/>
...
<br/><br/>
<div class="NitrogenousBaseHeader" style="color: #68e1e3;" onclick="selectTab('Cytosine')">Cytosine</div><br/>
...
var PosphateGroupDescription = "<div class='DescriptionHeader'>Posphate Group</div><br/>A functional group characterized by a phosphorus atom bonded to four oxygen atoms (three single bonds and one double bond). One of these oxygen atoms must be bonded to another atom; if not, the structure is a phosphate ion."
...
function resetAllTabs(){
    ...
    html_PosphateGroupId.style.backgroundColor = "#464646"
    html_HydrogenBondsId.style.backgroundColor = "#464646"
    html_PosphodiesterBondsId.style.backgroundColor = "#464646"
}
...
function selectTab(whatTab){
    switch (whatTab){
        ...
        case ("PosphateGroup"):
            html_DNADescription.innerHTML = PosphateGroupDescription
            resetAllTabs()
            html_PosphateGroupId.style.backgroundColor = "#457330"
            alreadyHitSomething = false
            hasSelected = true
            animateGroupedBoop(PosphateGroup)
        break;
        ...
        case ("PosphodiesterBonds"):
            html_DNADescription.innerHTML = PosphodiesterBondsDescription
            resetAllTabs()
            html_PosphodiesterBondsId.style.backgroundColor = "#457330"
            alreadyHitSomething = false
            hasSelected = true
            animateGroupedBoop(PosphodiesterGroup)
        break;    
